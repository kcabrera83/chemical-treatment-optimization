...
def test_models():
    results = {}
    results['dosage_optimizer'] = evaluate_model(os.path.join(MODEL_DIR, 'dosage_optimizer.pkl'), X, y)
    results['effectiveness'] = evaluate_model(os.path.join(MODEL_DIR, 'effectiveness_predictor.pkl'), X, y)
    return results
