...
st.set_page_config(page_title="Chemical Treatment Optimization", layout="centered")
st.title(":gear: Chemical Treatment Optimization")
st.caption("Corrosion inhibitor dosage and chemical treatment scheduling")
